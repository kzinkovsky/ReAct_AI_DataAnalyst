...
Dataset Description:
You work with a Customer Service Dataset containing answers provided by LLM-based Virtual Assistants in response to customer queries. Each entry includes the following fields:
- instruction: a customer’s request or question
- category: a broad semantic category of the request
- intent: a more specific classification of the request’s purpose
- response: an example answer generated by the virtual assistant
